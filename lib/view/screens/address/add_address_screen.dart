...
class _AddAddressScreenState extends State<AddAddressScreen> {
                        ...
                        child: SizedBox(
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                      height: Dimensions.PADDING_SIZE_LARGE),
                                  mandatoryText('street_number'.tr,
                                  ...
                                  SizedBox(
                                      height: Dimensions.PADDING_SIZE_LARGE),
                                  mandatoryText(
                                      'house'.tr, Dimensions.fontSizeSmall),
                                  ...
                                  SizedBox(
                                      height: Dimensions.PADDING_SIZE_LARGE),
                                  mandatoryText(
                                      'floor'.tr, Dimensions.fontSizeSmall),
                                  SizedBox(
                                      height: Dimensions.PADDING_SIZE_SMALL),
                                  MyTextField(
                                    hintText: 'floor'.tr,
  ...
  RichText mandatoryText(String s, double fontSize) {
    return RichText(
      text: TextSpan(
          text: '$s',
          style: TextStyle(
              color: Theme.of(context).disabledColor, fontSize: fontSize),
          children: [
            TextSpan(
                text: ' *',
